...
# 读取csv文件
data = np.genfromtxt('C:\\Users\\Admin\\Desktop\\TE化工数据集\\测试集\\d06_te.csv', delimiter=',')
...
# 将滤波后的数据保存为xlsx文件
filtered_data.to_excel('C:\\Users\\Admin\\Desktop\\小波滤波.xlsx', index=False)

# 创建保存图像的文件夹
save_folder = 'C:\\Users\\Admin\\Desktop\\小波滤波'
